if __name__ == "__main__":
    ...
    from tree.RegressionTree import BaseLineTree, StableTree1,sklearnBase,StableTree2,StableTree3, StableTree4,StableTreeM2,StableTree5
    import pandas as pd
    ...
    models = {  
                 ...
                 "MCMC": StableTree5(random_state=0, ntrees=5000)
            }
