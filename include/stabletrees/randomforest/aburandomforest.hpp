...
using namespace std;
class RandomForestABU{
    public:
        explicit RandomForestABU(int _criterion,int n_estimator,int max_depth, double min_split_sample,int min_samples_leaf, bool adaptive_complexity, int max_features);
...
RandomForestABU::RandomForestABU(int _criterion,int n_estimator,int max_depth, double min_split_sample,int min_samples_leaf, bool adaptive_complexity, int max_features){
    if(max_depth !=NULL){
...
//         forest[i]= AbuTree(_criterion, max_depth,  min_split_sample, min_samples_leaf,  adaptive_complexity,  max_features,1.0,  i);
//     }
...
iMatrix RandomForestABU::sample_indices(int start, int end){
