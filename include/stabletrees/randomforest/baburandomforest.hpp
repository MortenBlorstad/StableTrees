...
using namespace std;
class RandomForestBABU{
    public:
        explicit RandomForestBABU(int _criterion,int n_estimator,int max_depth, double min_split_sample,int min_samples_leaf, bool adaptive_complexity, int max_features,int bumping_iterations);
...
RandomForestBABU::RandomForestBABU(int _criterion,int n_estimator,int max_depth, double min_split_sample,int min_samples_leaf, bool adaptive_complexity, int max_features,int bumping_iterations){
    if(max_depth !=NULL){
