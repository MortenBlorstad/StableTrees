...
public:
    ...
    // Getters and setters
    void set_param(int nrounds_, double learning_rate_, double extra_param_, std::string loss_function_, double gamma);
    ...
    double stableloss(Tvec<double> &y, Tvec<double> &pred, Tvec<double> &w, Tvec<double> &prev_pred, double gamma);
    
    Tvec<double> dstableloss(Tvec<double> &y, Tvec<double> &pred, Tvec<double> &prev_pred, double gamma);
    
    Tvec<double> ddstableloss(Tvec<double> &y, Tvec<double> &pred, Tvec<double> &prev_pred, double gamma);
