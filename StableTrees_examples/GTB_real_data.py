...
markers = {"baseline":"B", "SL4":"SL_{0.25}","SL5":"SL_{0.5}","SL6":"SL_{0.75}"   }
...
models = {  
                ...
                "SL4":GradientBoosting(1000  , criterion=criterion,adaptive_complexity=True, learning_rate=0.01),
                "SL5":GradientBoosting(1000  , criterion=criterion,adaptive_complexity=True, learning_rate=0.01),
                "SL6":GradientBoosting(1000  , criterion=criterion,adaptive_complexity=True, learning_rate=0.01),     
                }
...
for ds,target, feature in zip(datasets,targets, features):
    ...
    for train_index, test_index in kf.split(X):
        ...
        criterion = "mse"
        models = {  
                "baseline": GradientBoosting(30  , criterion=criterion,adaptive_complexity=True, learning_rate=0.01),
                "SL4":GradientBoosting(30  , criterion=criterion,adaptive_complexity=True, learning_rate=0.01),
                "SL5":GradientBoosting(30  , criterion=criterion,adaptive_complexity=True, learning_rate=0.01),
                "SL6":GradientBoosting(30  , criterion=criterion,adaptive_complexity=True, learning_rate=0.01),
                }
        gamma = 0.25
...
plt.savefig(f"StableTrees_examples\plots\\GTB_real_data_mse_pareto.png")
plt.close()