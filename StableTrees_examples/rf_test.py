...
from stabletrees.tree import BaseLineTree,Node,Tree, AbuTree, TreeReevaluation, StabilityRegularization,BABUTree,NaiveUpdate
...
t = AbuTree(max_features=2, adaptive_complexity=True)
